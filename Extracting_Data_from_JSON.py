...
#then parse and extract the comment counts from the JSON data, compute the sum of the numbers 
...
#Actual data: http://py4e-data.dr-chuck.net/comments_1426898.json (Sum ends with 33)
...
if len(url) < 1:
    url = 'http://py4e-data.dr-chuck.net/comments_1426898.json'
